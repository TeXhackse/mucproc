%%
%% This is file `mucproc_demo.tex' v. 1.0 2017/02/22, it is a demonstration file for the mucproc.cls class.
%% 
...
%Sofern zwei Autoren der gleichen Institution angehören, können Sie das optionale Argument von \thanks nutzen um ein Label auf eine Institution zu setzen. Diese kann anschließend mit \thanksref referenziert werden.
...
Die Literaturverweise werden, wie auch das Literaturverzeichnis durch das \textsf{biblatex}-Paket mit 
