...
\documentclass[ngerman,forcefinal
...
%Dies ist nur bei der Verwendung von OpenType-Schriftarten notwendig. Bei Verwendung von pdflatex dürfen die folgenden beiden Zeilen nicht verwendet werden.
\usepackage{iftex}
\ifPDFTeX
\else
...
Sofern nur eine Institution für den Beitrag angegeben wird, werden die Fußnotenmarker nicht gesetzt.
